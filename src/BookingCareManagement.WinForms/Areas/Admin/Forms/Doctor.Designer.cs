namespace BookingCareManagement.WinForms.Areas.Admin.Forms
{
    public partial class Doctor
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelCount.Location = new Point(246, 30);
            ...
            labelTitle.Size = new Size(213, 41);
            labelTitle.TabIndex = 0;
            labelTitle.Text = "Quản lý Bác sĩ";
            // 
            // panelControls
            // 
            ...
            dataGridViewDoctors.ColumnHeadersHeight = 45;
            dataGridViewDoctors.Columns.AddRange(new DataGridViewColumn[] { ColumnImage, ColumnName, ColumnEmail, ColumnPhone, ColumnSpecialty, ColumnStatus });
            ...
            dataGridViewDoctors.GridColor = Color.FromArgb(220, 220, 220);
            dataGridViewDoctors.Location = new Point(27, 31);
            dataGridViewDoctors.Margin = new Padding(3, 4, 3, 4);
            ...
            dataGridViewDoctors.RowTemplate.Height = 80;
            dataGridViewDoctors.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dataGridViewDoctors.Size = new Size(1546, 793);
            dataGridViewDoctors.TabIndex = 0;
            // 
            // ColumnImage
            // 
            ColumnImage.FillWeight = 15F;
            ...
            // ColumnSpecialty
            // 
            ColumnSpecialty.FillWeight = 15F;
            ColumnSpecialty.HeaderText = "Chuyên Khoa";
            ColumnSpecialty.MinimumWidth = 6;
